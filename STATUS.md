...
### 9. M1.6 — Визуальная приёмка (2026-09-19, коммит `<hash>`)
...
- Хвосты: `ChannelSwitcher` с аватаром и «Все каналы» — M3; правая колонка «Канона» 480 против 280–420 в
  `layout.md` — ждёт handoff; ⌘1…⌘3 для вкладок сценария в артборде 3 конфликтуют с ⌘1…⌘6 этапов — по `layout.md`;
  ширины «Идей» 300 / 340 в `layout.md` отсутствуют; подвал оверлея про настройки — после M11; эталоны привязаны к
  Linux-рендеру шрифтов (`-linux` в имени), на другой ОС нужны свои.
