...
Модуль **M1** (`docs/tasks/M1.md`), следующий этап — **M1.5 Каталог состояний (экран 10)** (`docs/tasks/M1.5.md`,
Sonnet, без плана). Стартовая фраза — в уставе модуля. После M1.6 — тег `m1`, затем отдельной сессией составить
