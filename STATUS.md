...
### 8. M1.5 — Каталог состояний (2026-09-19, коммит `<hash>`)
...
Модуль **M1** (`docs/tasks/M1.md`), следующий этап — **M1.6 Визуальная приёмка** (`docs/tasks/M1.6.md`, Sonnet,
без плана); входной список — `docs/m1_review_list.md`. После M1.6 — тег `m1`, затем отдельной сессией составить
